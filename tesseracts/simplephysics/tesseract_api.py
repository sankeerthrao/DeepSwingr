...
"""
Tesseract API module for simplephysics tesseract
...
weights_path = this_dir / "weights" / "simplephysics_weights.msgpack"


class InputSchema(BaseModel):
    """Input schema for simplephysics tesseract"""
...
class OutputSchema(BaseModel):
    """Output schema for simplephysics tesseract"""
...
class SimplePhysicsModel(eqx.Module):
...
def load_weights():
    ...
    return SimplePhysicsModel(model=model, params=params)
